...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default=r'D:\DL-GuPao\YOLO5\yolov5-master\weights\yolov5s.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default=r'D:\DL-GuPao\YOLO5\yolov5-master\models\yolov5s.yaml', help='model.yaml path')#网络配置
    parser.add_argument('--data', type=str, default=r'D:\DL-GuPao\YOLO5\MaskDataSet\data.yaml', help='data.yaml path')#数据
