...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r'D:\DL-GuPao\YOLO5\yolov5-master\yolov5s.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default=r'D:\DL-GuPao\YOLO5\MaskDataSet\data.yaml', help='*.data path')
