...
def train(hyp, opt, device, tb_writer=None):
    ...
    if opt.linear_lr:
        ...
        lf = one_cycle(1, hyp['lrf'], epochs)  # cosine 1->hyp['lrf'] One Cycle的学习率变化过程是从lr0=0.01呈余弦变化衰退到lr0*lrf = 0.01*0.1 = 0.001
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/neu.yaml', help='data.yaml path')
