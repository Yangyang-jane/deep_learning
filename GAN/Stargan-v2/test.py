...
if __name__ == '__main__':
    ...
    parser.add_argument('--inp_dir', type=str, default='assets/representative/fundus/female',
                        help='input directory when aligning faces')
    parser.add_argument('--out_dir', type=str, default='assets/representative/fundus/src/female',
